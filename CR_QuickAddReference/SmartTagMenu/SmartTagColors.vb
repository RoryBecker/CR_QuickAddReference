...
Public MustInherit Class SmartTagColors
    ...
    MustOverride ReadOnly Property DarkColor() As Color
    MustOverride ReadOnly Property LightColor() As Color
...
#Region "InActive"
    Public Overrides ReadOnly Property TitleBackgroundColor() As Color
        Get
            Return LightColor ' Whatever is set here seems to bleed out left. Go figure.
        End Get
    End Property
